...
set "WV_FOUND=0"
reg query "HKLM\SOFTWARE\WOW6432Node\Microsoft\EdgeUpdate\Clients\{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}" >nul 2>nul && set "WV_FOUND=1"
reg query "HKCU\SOFTWARE\Microsoft\EdgeUpdate\Clients\{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}" >nul 2>nul && set "WV_FOUND=1"
if "%WV_FOUND%"=="1" (
...
echo [INFO] File size: %FILESIZE% bytes
echo.
echo You can now run SNEERYBOOSTER V1 by double-clicking:
echo %DEST_EXE%
echo.
